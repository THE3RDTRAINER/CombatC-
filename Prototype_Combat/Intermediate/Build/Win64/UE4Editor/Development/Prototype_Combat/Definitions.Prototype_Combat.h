...
#define ORIGINAL_FILE_NAME "UE4Editor-Prototype_Combat.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_PROJECT_NAME Prototype_Combat
...
#define PROTOTYPE_COMBAT_API DLLEXPORT
